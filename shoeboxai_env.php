<?php
// filename  shoeboxai_env.php
// purpose   top leve include file for php variables et al
// usage     include "shoeboxai_env.php";
// history
...
// form hints
//
$form_q_home   = 'ShoeboxAI home page';
$form_q_apinv  = 'ShoeboxAI A/P Invoices';
$form_q_appay  = 'ShoeboxAI A/P Pay Invoices';
$form_q_arinv  = 'ShoeboxAI A/R Invoices';
$form_q_arpay  = 'ShoeboxAI A/R Receipts';
$form_q_comp   = 'ShoeboxAI Companies: Customers and Vendors';
$rptpage        = "";
$form_q_acct   = 'ShoeboxAI Chart of Accounts';
...
$form_q_admin  = 'View and manage ShoeboxAI metadata here';
$form_q_login  = 'ShoeboxAI login or logout';
...
foreach ($todo_type_msg as $key => $val) {
...
foreach ($todo_st_msg as $key => $val) {
